...
static int bandpass( const double _Complex *, const double _Complex *, const int *,
					const double, const double, const double, IIR_FILTER * );
static int bandreject( const double _Complex *, const double _Complex *, const int *,
					const double, const double, const double, IIR_FILTER * );
static int lowpass( const double _Complex *, const double _Complex *,
					const int *, const double, IIR_FILTER * );
static int highpass( const double _Complex *, const double _Complex *,
					const int *, const double, IIR_FILTER * );
...
static int lowpass( const double _Complex *poles, const double _Complex *zeros,
					const int *rtype, const double dcvalue, IIR_FILTER *filter )
{
	int       i;
	double    scale;
	double    tmppole;
...
static int highpass( const double _Complex *poles, const double _Complex *zeros,
					const int *rtype, const double dcvalue, IIR_FILTER *filter )
{
	int       i;
	double    scale;
...
static int bandpass( const double _Complex *poles, const double _Complex *zeros, const int *rtype,
...
static int bandreject( const double _Complex *poles, const double _Complex *zeros, const int *rtype,
					const double dcvalue, const double freql, const double freqh, IIR_FILTER *filter )
{
	const double a = PI2 * PI2 * freql *freqh;
	const double b = PI2 * (freqh - freql);
